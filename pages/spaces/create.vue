<template>
  ...
  <NuxtLayout v-else name="authenticated"
    ...
    <!-- CREATE A SAVINGS SPACE -->
    <div data-test="create-space-main" class="flex flex-col flex-grow px-6 py-4 md:px-8 md:py-6 overflow-scroll">
      <div>
        Create a new savings space
      </div>
    </div>
  </NuxtLayout>
</template>
